...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'build/404.data';
  ...
  Module['FS_createPath']("/", "res", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_build/404.data');

      };
      Module['addRunDependency']('datafile_build/404.data');
   ...
   loadPackage({"files": [{"filename": "/res/404mac.png", "start": 0, "end": 734}], "remote_package_size": 734, "package_uuid": "c04f9df7-9216-4a0d-9614-6d4cd40e711b"});
