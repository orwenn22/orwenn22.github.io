...
var ASM_CONSTS = {
  85016: () => { if (document.fullscreenElement) return 1; },  
 85062: () => { return document.getElementById('canvas').width; },  
 85114: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85182: () => { document.exitFullscreen(); },  
 85209: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 85282: () => { if (document.fullscreenElement) return 1; },  
 85328: () => { return document.getElementById('canvas').width; },  
 85380: () => { return screen.width; },  
 85405: () => { document.exitFullscreen(); },  
 85432: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 85565: () => { if (document.fullscreenElement) return 1; },  
 85611: () => { return document.getElementById('canvas').width; },  
 85663: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85731: () => { if (document.fullscreenElement) return 1; },  
 85777: () => { return document.getElementById('canvas').width; },  
 85829: () => { return screen.width; },  
 85854: () => { if (document.fullscreenElement) return 1; },  
 85900: () => { return document.getElementById('canvas').width; },  
 85952: () => { return screen.width; },  
 85977: () => { document.exitFullscreen(); },  
 86004: () => { if (document.fullscreenElement) return 1; },  
 86050: () => { return document.getElementById('canvas').width; },  
 86102: () => { return parseInt(document.getElementById('canvas').style.width); },  
 86170: () => { document.exitFullscreen(); },  
 86197: () => { return screen.width; },  
 86222: () => { return screen.height; },  
 86248: () => { return window.screenX; },  
 86275: () => { return window.screenY; },  
 86302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 86355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 86426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 86483: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 86554: () => { if (document.fullscreenElement) return 1; },  
 86600: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 86647;
var ___stop_em_js = Module['___stop_em_js'] = 86720;
