...
var ASM_CONSTS = {
  85032: () => { if (document.fullscreenElement) return 1; },  
 85078: () => { return document.getElementById('canvas').width; },  
 85130: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85198: () => { document.exitFullscreen(); },  
 85225: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 85298: () => { if (document.fullscreenElement) return 1; },  
 85344: () => { return document.getElementById('canvas').width; },  
 85396: () => { return screen.width; },  
 85421: () => { document.exitFullscreen(); },  
 85448: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 85581: () => { if (document.fullscreenElement) return 1; },  
 85627: () => { return document.getElementById('canvas').width; },  
 85679: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85747: () => { if (document.fullscreenElement) return 1; },  
 85793: () => { return document.getElementById('canvas').width; },  
 85845: () => { return screen.width; },  
 85870: () => { if (document.fullscreenElement) return 1; },  
 85916: () => { return document.getElementById('canvas').width; },  
 85968: () => { return screen.width; },  
 85993: () => { document.exitFullscreen(); },  
 86020: () => { if (document.fullscreenElement) return 1; },  
 86066: () => { return document.getElementById('canvas').width; },  
 86118: () => { return parseInt(document.getElementById('canvas').style.width); },  
 86186: () => { document.exitFullscreen(); },  
 86213: () => { return screen.width; },  
 86238: () => { return screen.height; },  
 86264: () => { return window.screenX; },  
 86291: () => { return window.screenY; },  
 86318: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 86371: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 86442: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 86499: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 86570: () => { if (document.fullscreenElement) return 1; },  
 86616: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 86663;
var ___stop_em_js = Module['___stop_em_js'] = 86736;
