...
var ASM_CONSTS = {
  85064: () => { if (document.fullscreenElement) return 1; },  
 85110: () => { return document.getElementById('canvas').width; },  
 85162: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85230: () => { document.exitFullscreen(); },  
 85257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 85330: () => { if (document.fullscreenElement) return 1; },  
 85376: () => { return document.getElementById('canvas').width; },  
 85428: () => { return screen.width; },  
 85453: () => { document.exitFullscreen(); },  
 85480: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 85613: () => { if (document.fullscreenElement) return 1; },  
 85659: () => { return document.getElementById('canvas').width; },  
 85711: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85779: () => { if (document.fullscreenElement) return 1; },  
 85825: () => { return document.getElementById('canvas').width; },  
 85877: () => { return screen.width; },  
 85902: () => { if (document.fullscreenElement) return 1; },  
 85948: () => { return document.getElementById('canvas').width; },  
 86000: () => { return screen.width; },  
 86025: () => { document.exitFullscreen(); },  
 86052: () => { if (document.fullscreenElement) return 1; },  
 86098: () => { return document.getElementById('canvas').width; },  
 86150: () => { return parseInt(document.getElementById('canvas').style.width); },  
 86218: () => { document.exitFullscreen(); },  
 86245: () => { return screen.width; },  
 86270: () => { return screen.height; },  
 86296: () => { return window.screenX; },  
 86323: () => { return window.screenY; },  
 86350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 86403: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 86474: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 86531: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 86602: () => { if (document.fullscreenElement) return 1; },  
 86648: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 86695;
var ___stop_em_js = Module['___stop_em_js'] = 86768;
