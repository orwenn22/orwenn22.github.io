...
// include: /tmp/tmp4l2r5fbo.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'adeterminer.data';
      var REMOTE_PACKAGE_BASE = 'adeterminer.data';
...
Module['FS_createPath']("/", "res", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_adeterminer.data');

      };
      Module['addRunDependency']('datafile_adeterminer.data');
