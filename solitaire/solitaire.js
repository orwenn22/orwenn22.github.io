...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'solitaire.data';
      var REMOTE_PACKAGE_BASE = 'solitaire.data';
...
Module['FS_createPath']("/", "res", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_solitaire.data');

      };
      Module['addRunDependency']('datafile_solitaire.data');
    ...
    loadPackage({"files": [{"filename": "/res/carreau.png", "start": 0, "end": 650}, {"filename": "/res/clover.png", "start": 650, "end": 1302}, {"filename": "/res/heart.png", "start": 1302, "end": 8199}, {"filename": "/res/pic.png", "start": 8199, "end": 8858}], "remote_package_size": 8858});
